...
class DataEngine:
    ...
    def get_dashboard_data(self):
        ...
        if os.path.exists(self.excel_path):
            try:
                ...
                # Columnas esperadas según ExcelExporter: entidad_id, valor_resultado, detalles_resumen
    ...
    def _extract_competencies(self, df):
        results = {}
        # El campo 'detalles_resumen' tiene el formato "Criterio 1 (Puntos), Criterio 2 (Puntos)..."
